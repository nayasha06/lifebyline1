...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
       ...
       JLabel additionalDetails=new JLabel("Page 2: Additional Details");
        ...
        String occupationalvalue[] = {"Salaried", "Self Employed", "Bussiness", "Retired", "Other"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
                Conn c = new Conn();
                String query = "insert into signuptwo values('"+formno+"', '"+sreligion+"', '"+scategory+"','"+sincome+"', '"+seducation+"', '"+soccupation+"', '"+span+"', '"+saadhar+"', '"+seniorcitizen+"', '"+exsitingaccount+"')";
